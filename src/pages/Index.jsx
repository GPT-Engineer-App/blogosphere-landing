...
const Index = () => {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="py-20 px-4 text-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Unleash Your Writing Potential</h1>
        <p className="text-xl text-white mb-8">Create, share, and inspire with our powerful blogging platform</p>
        <Button size="lg" className="bg-white text-purple-600 hover:bg-gray-100">Start Writing Now</Button>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">Join thousands of writers who have found their voice on our platform.</p>
          <Button size="lg" className="bg-purple-600 text-white hover:bg-purple-700">Sign Up for Free</Button>
        </div>
      </section>
    </div>
  );
